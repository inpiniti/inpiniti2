<template>
  <div
    class="flex lg:flex-col flex-row lg:w-40 w-full overflow-y-scroll scrollbar scrollbar-w scrollbar-h flex-shrink-0"
  >
    <div class="px-3 py-1 sticky top-0 left-0 bg-neutral-900 z-10">
      {{ title }}
    </div>
    <button
